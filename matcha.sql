...
on the European continent.', 'heterosexual', 37.61556, 55.75222),
...
with Singapore and Hong Kong, in 2018.', 'bisexual', 2.352221, 48.856614),
...
political and economic hub. Its historical old town was designated a UNESCO World Heritage Site', 'heterosexual', 21.012228, 52.229675),
...
and lies 1–10 m (3 ft 3 in–32 ft 10 in) above sea level, on a flat and sandy plain', 'homosexual', 24.105186, 56.949648),
...
and Rhine-Main regions.', 'heterosexual', 13.404954, 52.520006),
...
Greater London is governed by the Mayor of London and the London Assembly', 'homosexual', -0.127758, 51.507350),
...
Athens dominates the Attica region and is one of the world s oldest cities, with its recorded history spanning over 3,400 years
 and its earliest human presence started somewhere between the 11th and 7th millennium BC', 'bisexual', 23.729359, 37.983917),
...
the only existing example of a country within a city; for this reason Rome has sometimes been defined as the capital of two states', 'heterosexual', 12.496365, 41.902783),
...
New York is an important center for international diplomacy', 'heterosexual', -74.005941, 40.712783),
...
of the states population.', 'homosexual', 151.20699, -33.867486),
...
Chhatrapati Shivaji Maharaj Terminus, and the citys distinctive ensemble of Victorian and Art Deco buildings.', 'bisexual', 72.877655, 19.075983),
...
the three divisions form the Jingjinji megalopolis and the national capital region of China.', 'heterosexual', 116.407395, 39.904211),
...
recorded in the 2010 Russian census. Harbin in China is about 515 kilometres (320 mi) away, while Sapporo in Japan is about 775 kilometres (482 mi) east across the Sea of Japan.', 'bisexuall', 131.9, 43.133333),
...
Cape Town is home to 64% of the Western Capes population', 'heterosexual', 18.424055, -33.924868),
...
and is titled "the city of a thousand minarets" for its preponderance of Islamic architecture. Cairo is considered a World City with a "Beta +" classification according to GaWC.', 'heterosexual', 31.235711, 30.044419),
...
Among major Latin American cities, it has the highest GDP per capita', 'heterosexual', -47.882165, -15.794228),
...
A 2017 official estimate reported a population of 1,029,556 within the city limits, making it the second-largest city in the country, behind Almaty, the capital from 1991 to 1997', 'bisexual', 71.470355, 51.160522),
...
the centre of Mongolias road network and connected by rail to both the Trans-Siberian Railway in Russia and the Chinese railway system', 'heterosexual', 106.92, 47.92),
...
the Santiago Metropolitan Region, whose total population is 7 million. The city is entirely located in the countrys central valley. Most of the city lies between 500 m (1,640 ft) and 650 m (2,133 ft) above mean sea level.', 'homosexual', -70.641997, -33.469119),
...
Helsinki is located 80 kilometres (50 mi) north of Tallinn, Estonia, 400 km (250 mi) east of Stockholm, Sweden, and 300 km (190 mi) west of Saint Petersburg, Russia. It has close historical ties with these three cities.', 'heterosexual', 24.941024, 60.173324);
